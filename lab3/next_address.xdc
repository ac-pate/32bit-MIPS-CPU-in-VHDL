...
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33 }[get_ports { rt_in[0]}];
set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33 }[get_ports { rt_in[1]}];
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33 }[get_ports { rt_in[2]}];
...
set_property -dict {PACKAGE_PIN R6 IOSTANDARD LVCMOS33 }[get_ports { branch_type[0]}];
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33 }[get_ports { branch_type[1]}];

set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33 }[get_ports { pc_sel[0]}];
